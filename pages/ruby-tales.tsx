    ...
    return (
        <>
            ...
            <HomeHero displayImages={false}>
                <p className="text-left">My name is Lara Katz, and I am a member of Princeton&rsquo;s Class of 2024,
                ...
                <br/>
                <p className="text-left">My contemporary fairy tale,&nbsp;<span className="italic">Ruby Tales</span>,
                    focuses on reversing tropes and expectations around
                    ...
                    not absent from&nbsp;<span className="italic">Ruby Tales</span>, but Aeon&rsquo;s necessarily fluid,
                    innately degendered perspective
                    strips their point-of-view (POV) from the fundamental assumption that <span
                        className="italic">gender&nbsp;must exist and
                    define their whole identity</span>&nbsp;as a conscious being.</p>
                <br/>
                <p className="text-left">Sexuality, relationships, first impressions, life paths, etc. are all defined,
                ...
                <br/>
                <p className="text-left">Some fairy tales which inspired me include David Mitchell&rsquo;s&nbsp;<span
                    className="italic">Slade
                    House</span>&nbsp;(character-driven, episodic long-form fairy tale), Kim Fu&rsquo;s &ldquo;In This
                    Fantasy&rdquo; (a kaleidoscopic method of narrowing in on a character), and Nnedi
                    Okorafor&rsquo;s&nbsp;<span className="italic">Lagoon</span>&nbsp;(a modern world in which human-adjacent creatures try to find
                ...
                <br/>
                <p className="text-left">Placing this uniquely perspectived character into the middle of a congested
                    human society might have
                ...
                <br/>
                <p className="text-left">By pressing together in a small space Aeon and Morv, two characters who hardly
                ...
                <br/>
                <p className="text-left">Lastly, as a background narrative, Aeon, like all kids,
                    babies, &ldquo;quaranteens&rdquo; etc.,
